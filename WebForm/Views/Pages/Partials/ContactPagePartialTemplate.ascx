<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactPagePartialTemplate.ascx.cs" Inherits="WebForm.Views.Pages.Partials.ContactPagePartialTemplate" %>
