<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactPagePartialTemplateWide.ascx.cs" Inherits="WebForm.Views.Pages.Partials.ContactPagePartialTemplateWide" %>
